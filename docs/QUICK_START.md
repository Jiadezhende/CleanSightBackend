...
> 所有 HTTP/WS 请求先经 `GatewayMiddleware`（IP 白名单 / 速率限制 / 反扫描），详见 [SERVICE_GATEWAY_MEDIAMTX.md](kb/INDEX.md)。对外 RTSP 端口 8004 也由 `mediamtx_gateway` 代理。

详细 API 文档见 [API 端点文档](kb/INDEX.md)。
...
- [API 端点文档](kb/INDEX.md) - 详细 API 说明
- [流处理服务](kb/INDEX.md) - RTSP 流处理细节
