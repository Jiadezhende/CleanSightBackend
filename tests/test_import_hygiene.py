...
BUDGET = {
    ...
    # 这是 D1 允许的唯一一档 L1 依赖；`_temporal` 的货币 TemporalEvent / TemporalSegment 是纯 stdlib dataclass。
    ...
    "app.storage.inference._temporal":  (set(), 0.40),   # stdlib only（TemporalEvent / TemporalSegment 不带 numpy）
